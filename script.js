...
console.log(compareNumbers(13, 15))
...
console.log (calculator(14, 88, "+"))
console.log (calculator(45, 38, "-"))
console.log (calculator(12, 2, "*"))
console.log (calculator(99, 9, "/"))
...
console.log(checkPrice(50))

 


// 14.⁠ ⁠რიცხვების დადებითი ჯამი
